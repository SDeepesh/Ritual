        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
          {contactInfo.map((item, idx) => (
            <div key={idx} className="bg-white rounded-[20px] border border-brand-beige/20 p-6 flex items-center gap-4 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
              <div className="w-12 h-12 rounded-xl bg-brand-sage/10 flex items-center justify-center text-brand-sage flex-shrink-0">
                {item.icon}
              </div>
              <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="bg-brand-olive text-white p-8 md:p-12 rounded-[20px] shadow-xl relative overflow-hidden flex flex-col justify-between">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center text-brand-beige flex-shrink-0 mt-0.5">
            ...
            <div className="flex gap-3 mt-8 relative z-10">
              <a href="https://www.instagram.com/ritualwellness.in" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center hover:bg-white/20 transition-all" aria-label="Instagram">
              ...
              <a href="https://wa.me/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center hover:bg-white/20 transition-all" aria-label="WhatsApp">
          ...
          <div className="bg-[#fcfaf7] p-8 md:p-10 rounded-[20px] border border-brand-beige/30 relative overflow-hidden">
            ...
            <form className="space-y-5 relative z-10" onSubmit={handleSubmit}>
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  rows="4"
                  className="w-full bg-white border border-brand-beige/20 rounded-xl px-5 py-4 focus:ring-1 focus:ring-brand-sage focus:border-brand-sage transition-all outline-none text-brand-olive resize-none"
                  required
