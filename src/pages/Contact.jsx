        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="bg-brand-olive text-white p-8 md:p-12 rounded-[20px] shadow-xl relative overflow-hidden flex flex-col justify-between">
            ...
            <div className="flex gap-3 mt-8 relative z-10">
              ...
              <a href="https://wa.me/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-md bg-white/10 flex items-center justify-center hover:bg-white/20 transition-all" aria-label="WhatsApp">
